...
class Level:
    ...
    def give_food(self):
        if self.next and self.food >= 10:
            ...
            print("Not enough food, you are dead")
    ...
    def share_food(self):
        if self.next and self.food >= 5:
            ...
            print("Not enough food to share, you are dead")
...
while True:
    ...
    print("5 - Who am I?")
    print("6 - Destroy next level (remove all its food)")
    print("7 - Exit")
    ...
    if choice == "1":
        ...
        player.who_is_here(current_level) 
    elif choice == "6":
        if current_level.next:
